        ...
        <div className="mb-8">
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              <button className="bg-green-600 text-white px-4 py-2 rounded-t-lg">
                Field Overview
              </button>
              <button className="text-gray-500 hover:text-gray-700 px-4 py-2 border-b-2 border-transparent hover:border-gray-300">
                Crop Monitoring
              </button>
              <button className="text-gray-500 hover:text-gray-700 px-4 py-2 border-b-2 border-transparent hover:border-gray-300">
                Harvest Planning
